...
public abstract class AbstractSelectorCompilerDecorator implements Selector.Compiler.Decorator {
	...
	public AbstractSelectorCompilerDecorator(AsyncXMLStreamer streamer) {
